        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col" style="height: 580px;">
                <a href="../products/coffee-blend-box.jsp" class="text-decoration-none text-reset">
                    <div class="card my_card h-100 position-relative overflow-hidden">
                        ...
                        <div class="overlay-text text-center">
                            <p class="fw-bold mb-0">시그니쳐 블렌드 세트</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col" style="height: 580px;">
                <a href="#" class="text-decoration-none text-reset">
                    <div class="card my_card h-100 position-relative overflow-hidden">
                        <div class="image-wrapper">
                            <img src="./images/Blue-Bottle-Pour-Over-Kit-M1-Component-Detail_33a04dbb-0db8-4406-8655-adf975529cc2.webp" class="card-img-top base-img position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="...">
                            <img src="./images/Blue-Bottle-Pour-Over-Kit-Hover-M2.webp" class="card-img-top hover-img position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="...">
                        </div>
                        <div class="overlay-text text-center">
