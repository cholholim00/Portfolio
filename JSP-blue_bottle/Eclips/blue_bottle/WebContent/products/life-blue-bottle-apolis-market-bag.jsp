...
<html lang="en">
  <head>
    ...
    <title>마켓백 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/MarketBag_01_1600x1600_4c38f0a0-4e7d-4b89-88cd-51854d785762.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">마켓백</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀 마켓백은 지속가능한 성장을 추구하는 브랜드<br>
            	아폴리스와의 협업으로 탄생한 제품으로, 100% 천연 황마<br>
            	소재의 자연스러운 질감을 살렸습니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀이 시작된 오클랜드, 캘리포니아의 이름을<br>
            	캐주얼하게 담아낸 텍스트 프린트가 디자인의<br>
            	포인트입니다.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \110,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">마켓백</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">110,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">110,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">110,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="마켓백" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="4-007">
                            <input type="hidden" name="img_src" value="../products/images/MarketBag_01_1600x1600_4c38f0a0-4e7d-4b89-88cd-51854d785762.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 5%;">
            ...
            <p class="fs-3 fw-medium mb-4">디자인과 실용성의 완벽한 조화</p>
            <p class="mb-5" style="line-height: 30px;">
               	 아폴리스의 시그니처 디자인 요소인 텍스트 프린트는<br>
               	 블루보틀의 시작을 기념하며 오클랜드(Oakland), 캘리포니아<br>
               	 (California)를 캐주얼하게 담아냈습니다. 내부에는 생활방수<br>
               	 코팅 처리가 되어 있어 실용적이며, 데일리백으로<br>
               	 활용하기에도 적합합니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Market_Bag_Mid_1600x1600_eec02675-6518-424b-a0f7-a2d821e43b49.jpg" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/Market_Bag_Low_2000x1125_97e38849-eac2-4e7d-8254-013aada61389.webp" alt="" />
    </div>
