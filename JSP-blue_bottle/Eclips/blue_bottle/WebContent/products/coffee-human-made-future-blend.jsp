...
<html lang="en">
  <head>
    ...
    <title>휴먼 메이드 퓨처 블렌드 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%; margin-top: 1%;">
            <img src="./images/01_001_Future_Blend_1600x1600_9f8aa58e-f9df-4899-9ae4-85da2113b1ef.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 6%;">
            <p class="fs-3 fw-medium mb-4">휴먼 메이드 퓨처 블렌드</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	휴먼 메이드와 블루보틀 커피가 함께 만든 블렌드 커피로,<br>
            	과거에서 현대까지 이어지는 맛을 담아냈습니다. 베리와<br>
            	같은 꽃향이 나는 커피 원두를 중심으로, 캐러멜과 코코아<br>
            	풍미가 가미된 커피 원두와 블렌딩하여 무겁지 않으면서도<br>
            	깊이 있는 맛을 띕니다. 또, 달콤하고 균형 잡힌 맛으로<br>
            	친숙하면서도 독특하고 기억에 남는 맛을 나타냅니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	평소 싱글 오리진 커피를 즐기며, 내추럴 커피에 관심을<br>
            	가지고 있는 휴먼 메이드의 설립자 NIGO와 협력해 탄생한<br>
            	퓨처 블렌드는 베리류의 꽃향기를 내는 70%의 에티오피아<br>
            	내추럴 원두와 은은한 캐러멜/코코아 풍미를 담은 30%의<br>
            	페루 원두가 블렌딩 되었습니다.
            </p>
                    ...
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">휴먼 메이드 퓨처 블렌드</span>
                            ...
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="휴먼 메이드 퓨처 블렌드" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="1-009">
