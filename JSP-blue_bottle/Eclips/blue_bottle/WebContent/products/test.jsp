...
<html lang="en">
  <head>
    ...
    <title> - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/Hario-Cold-Brew-Pitcher-M1-Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">콜드브루 피처</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	몇 가지 간단한 준비만으로도 깊고 부드러운 콜드브루를<br>
            	집에서 완성할 수 있는 실용적인 아이템입니다. 넉넉한<br>
            	용량 (커피 추출량 기준 800ML)과 기존 콜드브루 보틀과의<br>
            	호환성으로 실용성을 높였으며, 세련된 디자인까지 겸비해<br>
            	키친에 감성을 더해줍니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	일상에 여유를 더하고 싶은 순간, 간편하면서도 완성도<br>
            	높은 홈카페를 위한 선택입니다.
            </p>
            ...
            <!-- form 태그 -->
            <!-- user_idx (GET method) -->
            <form action="./insertCart.jsp?idx=1" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                <!-- option -->
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \48,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">콜드브루 피처</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">48,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">48,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">48,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="휴먼 메이드 퓨쳐 블렌드" />	
                            <!-- product_idx -->
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        ...
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/human-made-future-blend2.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
