...
<html lang="en">
  <head>
    ...
    <title>휴먼 메이드 패스트 블렌드 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%; margin-top: 2%;">
            <img src="./images/01_001_Past_Blend_1600x1600_1628bc3d-92dc-412c-bc72-5c78cc89e3d6.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 6%;">
            <p class="fs-3 fw-medium mb-4">휴먼 메이드 패스트 블렌드</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	휴먼 메이드와 블루보틀 커피가 함께 만든 블렌드 커피로,<br>
            	과거에서 현대까지 이어지는 맛을 담아냈습니다. 두 가지의<br>
            	다른 로스팅 과정을 거친 원두를 블렌딩한 이 커피는 다크<br>
            	로스트 에티오피아가 띄는 블랙베리와 메이플의 단맛과<br>
            	라이트 로스트 에티오피아의 과일, 히비스커스 향이<br>
            	결합되어 부드러운 산미와 풍부한 맛을 나타냅니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	다른 지역의 커피를 섞지 않고 전통적인 내추럴 프로세스<br>
            	에티오피아 원두만을 사용한 이 커피는 다크 로스트 70%<br>
            	와 라이트 로스트 30%가 블렌딩되어 있습니다. 다크<br>
            	로스트는 콩코드 포도, 블랙베리, 초콜릿, 메이플의 맛을<br>
            	나타내며 산미가 부드럽고 풍부한 맛을 갖고 있기 때문에<br>
            	커피를 사랑하는 이들에게 만족감을 선사할 것으로<br>
            	기대합니다.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \30,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">휴먼 메이드 패스트 블렌드</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">30,000</span></span>
                                </div>
                            ...
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="휴먼 메이드 패스트 블렌드" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="1-008">
                            <input type="hidden" name="img_src" value="../products/images/human-made-future-blend.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 0;">
            <p class="fw-medium">블렌드 스토리</p>
            <p class="fs-3 fw-medium mb-4">휴먼 메이드 블렌드</p>
            <p class="mb-5" style="line-height: 30px;">
               	 휴먼 메이드는 '인간이 만든 것'을 존중하고 찬미하는 철학을<br>
               	 지니고 있습니다. 이는 모든 제품에 대한 감사의 마음을 담아<br>
               	 장인정신을 소중히 여기는 것으로, 전통적인 제작 기술과<br>
               	 세심한 디테일을 통해 매 작품에 인간의 손길이 깃들어 있음을<br>
               	 보여줍니다. NIGO는 이 철학을 통해, 현대의 패션이 단순히<br>
               	 트렌드에 그치지 않고, 오랜 시간 동안 계속해서 사랑받을 수<br>
               	 있는 가치를 지니도록 하고자 했습니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	블루보틀은 커피의 품질을 유지하기 위해 세심한 관리와<br>
                	장인정신을 고수하며 고객에게 최상의 커피 경험을<br>
                	제공합니다. 블루보틀의 품질에 대한 헌신과 휴먼 메이드의<br>
                	장인정신에 대한 찬미가 만나 탄생한 휴먼 메이드 블렌드는<br>
                	진정성과 감사의 마음을 담은 특별한 경험을 제공할 것으로<br>
                	기대됩니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/M3_Human_Made_1600x1600_996c5d6c-cf7e-4e36-8336-8b1633ef79dc.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/human-made-future-blend3.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
