...
<html lang="en">
  <head>
    ...
    <title>콜드브루 피처 - BLUE BOTTLE COFFEE KOREA</title>
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    ...
                                    <span class="text-muted mt-1 ms-5">₩<span id="unit-price">48,000</span></span>
                                </div>
                            ...
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="콜드브루 피처" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="3-001">
                            <input type="hidden" name="img_src" value="../products/images/Hario-Cold-Brew-Pitcher-M1-Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 4%;">
            ...
            <p class="mb-5" style="line-height: 30px;">
               	 ‘유리의 제왕’으로 불리는 하리오의 내열 유리 기술과<br>
               	 블루보틀의 감각적인 커피 철학이 만나, 가정에서도 부드럽고<br>
               	 깊은 풍미의 콜드브루를 간편하게 완성할 수 있는 특별한<br>
               	 피처를 선보입니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	견고한 품질과 세련된 디자인, 간편한 사용법으로 매일의 커피<br>
                	루틴에 신뢰와 아름다움을 동시에 더해줍니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Hario-Cold-Brew-Pitcher-M2-Desktop.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/Hario-Cold-Brew-Pitcher-M3-Desktop.webp" alt="" />
    </div>
