...
<html lang="en">
  <head>
    ...
    <title>콜드브루 커피 드리퍼 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/Blue-Bottle-Coffee-Dripper-M1-Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">콜드브루 커피 드리퍼</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	우리는 어딘가에 더 좋은 드리퍼가 있다는 것을 알았지만,<br>
            	어디에서도 찾을 수가 없었습니다. 최상의 푸어 오버를<br>
            	위해 블루보틀은 오랜 시간 과학자, 기술자들과 함께<br>
            	고민했습니다. 그리고 우리는 아주 특별한 디자인의<br>
            	드리퍼를 개발했습니다. 블루보틀 커피 드리퍼는 정교하게<br>
            	디자인 된 도자기 소재로 푸어 오버를 하는 동안 온도를<br>
            	유지해주며 균일하게 커피를 흐를 수 있도록 고안<br>
            	되었습니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀 커피 드리퍼와 함께 처음 내린 푸어 오버도<br>
            	맛있는 한 잔의 커피로 완성해 보세요.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \28,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">콜드브루 커피 드리퍼</span>
                                    <span class="text-muted mt-1 ms-5">₩<span id="unit-price">28,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">28,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">28,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="콜드브루 커피 드리퍼" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="3-005">
                            <input type="hidden" name="img_src" value="../products/images/Blue-Bottle-Coffee-Dripper-M1-Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 0;">
            ...
            <p class="fs-3 fw-medium mb-4">완벽한 푸어 오버</p>
            <p class="mb-5" style="line-height: 30px;">
               	 내부의 40개의 수직 돌기는 커피가 필터를 통과하여 노즐로 추출될때<br>
               	 일정한 속도로 흐르기 위한 가이드 역할을 합니다. 마치 나무가<br>
               	 뿌리로부터 잎사귀까지 수분을 운반하는 것처럼 이러한 추출 방법은<br>
               	 자연의 모세관 시스템에서 영감을 받았습니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	우리 드리퍼의 간결한 비율은 한 잔의 커피를 내리는데 최적화 되어<br>
                	있습니다. 드리퍼 내부는 커피를 추출하는 동안 일정한 흐름 속도를<br>
                	유지할 수 있는 최상의 커피 베드를 만듭니다. 오직 본질적인 필수<br>
                	요소들만 추구하면서 점차 정제된 디자인을 발견 할 수 있었습니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	좋은 드리퍼는 컵에 커피를 매끄럽고 자연스럽게 내보냅니다. 우리는<br>
                	단일 추출구가 내부 돌기와 함께 자연스럽게 연결되어 최상의 커피<br>
                	맛을 위한 흐름을 만들어내는 방법을 발견했습니다. 물을 부으면<br>
                	드리퍼 아래로 하나의 아름다운 커피 줄기가 나오는 것이 보일 거에요.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Blue-Bottle-Pour-Over-Kit-M3-Design-Detail1.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/Blue-Bottle-Pour-Over-Kit-M4-Lifestyle-Desktop_82746360-29cc-4dbc-8907-ba7e1b689e8c.webp" alt="" />
    </div>
