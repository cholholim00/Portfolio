...
<html lang="en">
  <head>
    ...
    <title>제이드 포셀린 라운드 컵 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%; margin-top: 3%">
            <img src="./images/M1_LNYJadeCup_Hero_02.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">제이드 포셀린 라운드 컵</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	2025년 을사년(乙巳年)을 맞아, 중국 전통 도자기 원료와<br>
            	청색 유약으로 제작된 제이드 포셀린 라운드 컵을<br>
            	소개합니다. 은은한 옥색이 담긴 이 컵은 따스한 감성과<br>
            	함께 새해의 특별함을 선사합니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	일상의 음료 한 잔도 제이드 포셀린 라운드 컵과 함께라면<br>
            	더욱 특별해집니다. 손에 부드럽게 감기는 곡선과 음료에<br>
            	집중할 수 있도록 설계된 디자인은 매일의 순간을 한층 더<br>
            	의미 있게 만들어 줍니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	모락모락 피어오르는 커피 향기와 함께, 제이드 포셀린<br>
            	라운드 컵과 새해를 더욱 풍요롭고 희망차게 시작해<br>
            	보세요.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \45,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">제이드 포셀린 라운드 컵</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">45,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">45,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">45,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 --> 
                            <!-- name -->
                            <input type="hidden" name="name" value="제이드 포셀린 라운드 컵" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="2-023">
                            <input type="hidden" name="img_src" value="../products/images/M1_LNYJadeCup_Hero_02.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 10%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 1%;">
            <p class="fw-medium">디자인 스토리</p>
            <p class="fs-3 fw-medium mb-4">한 해를 응원하는 메시지</p>
            <p class="mb-5" style="line-height: 30px;">
               	 손에 착 감기는 적당한 크기와 부드러운 곡선의 둥근 컵은<br>
               	 고풍스러움과 대범한 멋을 동시에 담아냅니다. 천연 느티나무 소재로<br>
               	 제작된 우드 컵 받침은, 2025년 을사년의 상징인 뱀 무늬를 정교하게<br>
               	 조각하여 특별함을 더했습니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
               	 제이드 포셀린 라운드 컵은 중국 차 문화의 전통에서 영감을 받아<br>
               	 제작되었습니다. 은은한 옥색을 띤 둥근 컵의 고풍스러운 디자인은<br>
               	 새해의 기쁨과 번영을 기원하며, 전통 문양과 색감을 현대적으로<br>
               	 재해석해 과거와 현재를 잇는 독창적인 미학을 표현합니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
               	 이 특별한 컵은 커피뿐만 아니라 허브티를 비롯한 다양한 음료와<br>
               	 완벽하게 어우러집니다. 집에서, 사무실에서, 혹은 소중한 사람들과의<br>
               	 만남에서도 제이드 포셀린 라운드 컵은 품격 있는 한 잔의 가치를<br>
               	 전달합니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/M2_LNYJadeCup_Desktop.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
