...
<html lang="en">
  <head>
    ...
    <title>서울 토트백 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/240705_Seoul-Tote-Bag.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">서울 토트백</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	고급스럽고 아름다운 한옥 기와에서 영감을 받아 제작된<br>
            	토트백입니다. 톡톡한 코튼 소재의 넉넉한 사이즈로<br>
            	노트북과 태블릿등을 편하게 수납할 수 있어 데일리 백으로<br>
            	사용하기에 좋습니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	현대적인 감각과 한국의 전통미가 어우러진 서울 토트백은<br>
            	일상을 더욱 특별하게 만들어 줄 거에요. (사이즈: 가로
            	35cm X 세로 40cm)
            </p>
                    ...
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">서울 토트백</span>
                            ...
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="서울 토트백" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="4-011">
                            <input type="hidden" name="img_src" value="../products/images/240705_Seoul-Tote-Bag.webp" />
    ...
    <!-- 블렌드 스토리 -->
    <div class="row">
			<img src="./images/240711-Seoul-Tote-Bag-2-Desktop.webp" alt="" />
    </div>
