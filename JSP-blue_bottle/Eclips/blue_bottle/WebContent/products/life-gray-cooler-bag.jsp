...
<html lang="en">
  <head>
    ...
    <title>그레이 코튼 쿨러백 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/240703_Gray-Cooler-Bag_1.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">그레이 코튼 쿨러백</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	여름철 음식이나 음료를 차갑게 유지하고 싶을 때 추천하는<br>
            	콤팩트한 사이즈의 쿨러백입니다. 도시락이나 블루보틀<br>
            	콜드브루 캔 6개를 안정적으로 수납할 수 있습니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	그레이 컬러 중앙에 새겨진 블루보틀 로고로 감각적인<br>
            	스타일을 완성할 수 있습니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	쌀쌀해지면 데운 음식이나 따듯한 음료를 위해 사용해<br>
            	보세요.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \23,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">그레이 코튼 쿨러백</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">23,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">23,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">23,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="그레이 코튼 쿨러백" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="4-010">
                            <input type="hidden" name="img_src" value="../products/images/240703_Gray-Cooler-Bag_1.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 3%;">
            ...
            <p class="fs-3 fw-medium mb-4">무더운 여름을 위한 가방</p>
            <p class="mb-5" style="line-height: 30px;">
               	 그레이 컬러의 코튼 소재로 제작되어 데일리 백으로<br>
               	 사용하기에 좋은 쿨러백으로 음식이나 도시락, 또는 피크닉을<br>
               	 위한 콜드브루 캔 등 다양한 짐을 편리하게 수납할 수<br>
               	 있습니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	코튼 캔버스 100%, 알루미늄 코팅된 안감으로 사이즈는 240<br>
                	X 240 X 150mm 입니다. 완전 밀폐 기능은 제공되지 않아<br>
                	단시간 휴대용으로 사용하시기 바랍니다. 오염된 부분은<br>
                	천으로 가볍게 닦아 주시기 바랍니다.(세탁 불가)
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/240711-Gray-Cooler-Bag-1.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/240711-Gray-Cooler-Bag-2-Desktop.webp" alt="" />
    </div>
