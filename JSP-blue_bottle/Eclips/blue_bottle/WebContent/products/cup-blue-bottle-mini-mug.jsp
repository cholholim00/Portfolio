...
<html lang="en">
  <head>
    ...
    <title>블루보틀 미니 머그 (200ml) - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/M1_KiyosumiMiniMug_Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">블루보틀 미니 머그 (200ml)</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	10년 전, 블루보틀과 라이프스타일 브랜드 클라스카와<br>
            	협업해 탄생한 머그는 곧 블루보틀의 상징적인 제품이<br>
            	되었습니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	10년이 지난 지금, 오리지널 디자인의 부드러운 곡선과<br>
            	부드러운 광택을 그대로 담은 미니 사이즈의 머그를<br>
            	선보입니다. 오리지널 블루보틀 머그의 작은 버전으로,<br>
            	손에 닿는 감촉이 부드럽고 음료를 더욱 기분 좋게 즐길 수<br>
            	있도록 제작되었습니다.
            </p>
                    ...
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">블루보틀 미니 머그 (200ml)</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">20,000</span></span>
                                </div>
                            ...
                            <!-- 결제 버튼 --> 
                            <!-- name -->
                            <input type="hidden" name="name" value="블루보틀 미니 머그 (200ml)" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="2-021">
                            <input type="hidden" name="img_src" value="../products/images/M1_KiyosumiMiniMug_Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 7%;">
            ...
            <p class="fs-3 fw-medium mb-4">스토리를 담은 아이템</p>
            <p class="mb-5" style="line-height: 30px;">
               	 클라스카와 협업하여 탄생한 미니 머그는 블루보틀 카페의<br>
               	 미니멀한 디자인 철학을 그대로 담고 있습니다. 유려한 곡선과<br>
               	 부드럽고 은은한 광택이 돋보이는 이 세라믹 머그는, 당신의<br>
               	 일상 속 머그 컬렉션에서 빠질 수 없는 아이템이 될 것입니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/M2_KiyosumiMiniMug_Desktop.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
