...
<html lang="en">
  <head>
    ...
    <title>블루보틀 텀블러 (500ml) - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/D1_Main_1600x1600_f3f43bab-d63e-4688-adc1-d2a78a251312.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">블루보틀 텀블러 (500ml)</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	500ml의 넉넉한 사이즈로 다양하게 활용할 수 있는<br>
            	텀블러를 소개합니다. 스테인리스 진공 이중 구조로 음료의<br>
            	온도와 향을 오래 유지하며, 결로 없이 쾌적하게 사용할 수<br>
            	있습니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	손에 꼭 맞는 곡선형 디자인과 간편한 리드 구조로 이동<br>
            	중에도 편안하고 안전하게 즐길 수 있는 텀블러입니다.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \34,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">블루보틀 텀블러 (500ml)</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">34,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">34,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">34,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="블루보틀 텀블러 (500ml)" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="2-003">
                            <input type="hidden" name="img_src" value="../products/images/D1_Main_1600x1600_f3f43bab-d63e-4688-adc1-d2a78a251312.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 5%;">
            ...
            <p class="fs-3 fw-medium mb-4">넉넉한 사이즈와 편안한 그립감</p>
            <p class="mb-5" style="line-height: 30px;">
               	 스테인리스 진공 이중 구조의 텀블러로 음료의 온기와 향을<br>
               	 오랫동안 지켜줍니다. 또한, 표면에 이슬이 맺히지 않아<br>
               	 깔끔하게 사용할 수 있으며, 보온과 보냉 기능 모두<br>
               	 뛰어납니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	손에 자연스럽게 감기는 곡선형 디자인으로 편안한 그립감을<br>
                	느낄 수 있으며, 간편한 리드 덕분에 이동 중에도 안정감 있게<br>
                	음료를 즐기실 수 있습니다. 500ml의 넉넉한 사이즈로 다양한<br>
                	음료를 편하게 담아 보관해보세요.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/D2_PC_64670d27-7557-4658-9823-4a24dee45aab.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
