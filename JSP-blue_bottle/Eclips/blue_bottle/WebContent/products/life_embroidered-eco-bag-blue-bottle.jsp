...
<html lang="en">
  <head>
    ...
    <title>엠브로이더리 에코 백 -블루보틀- - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/D1_Main_1600x1600_EmbroideredTote_BBC.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">엠브로이더리 에코 백 -블루보틀-</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	깔끔한 화이트 컬러에 블루보틀 로고가 더해진 감각적인<br>
            	에코백으로, 생활 방수 기능과 탄탄한 소재로 실용성을<br>
            	더했습니다. 넉넉한 수납력과 접을 수 있는 휴대성까지<br>
            	갖춰, 일상 어디서든 편안하게 사용할 수 있는 데일리<br>
            	백입니다.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \80,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">엠브로이더리 에코 백 -블루보틀-</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">80,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">80,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">80,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="엠브로이더리 에코 백 -블루보틀-" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="4-003">
                            <input type="hidden" name="img_src" value="../products/images/D1_Main_1600x1600_EmbroideredTote_BBC.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 3%;">
            ...
            <p class="fs-3 fw-medium mb-4">깔끔하고 모던한 디자인</p>
            <p class="mb-5" style="line-height: 30px;">
               	 심플한 화이트 컬러에 블루보틀 로고 자수가 은은한 포인트가<br>
               	 되는 감각적인 에코백입니다. 형태를 오래 유지하는 탄탄한<br>
               	 폴리에스터 소재와 생활 방수 마감으로, 날씨에 구애받지 않고<br>
               	 함께할 수 있습니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	넓은 입구 덕분에 부피 있는 소지품도 손쉽게 넣을 수 있으며,<br>
                	필요할 땐 가볍게 접어 휴대할 수 있어 실용성까지 갖춘 데일리<br>
                	백입니다. 미니멀한 디자인으로 다양한 스타일에 자연스럽게<br>
                	활용해보세요.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/D2_PC_EmbroideredTote_BBC.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/D3_PC_EmbroideredTote_BBC.webp" alt="" />
    </div>
