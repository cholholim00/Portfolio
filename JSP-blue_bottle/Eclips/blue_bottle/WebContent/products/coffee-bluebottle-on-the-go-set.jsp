...
<html lang="en">
  <head>
    ...
    <title>블루보틀 온더고 세트 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/on-the-go-set_D1_Main_1080x1080_c486dadc-648a-4948-bc7e-7edc79c330e1.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 11%;">
            <p class="fs-3 fw-medium mb-4">블루보틀 온더고 세트</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀의 크래프트 인스턴트 커피 에스프레소와 화이트<br>
            	트래블 머그 20oz를 함께 만나볼 수 있는 온더고 세트를<br>
            	소개합니다. 카페에서 마시던 깊고 풍부한 커피의 풍미를<br>
            	이제는 집에서도, 여행지에서도 간편하게 누려보세요.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \81,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">블루보틀 온더고 세트</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">81,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">81,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">81,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="블루보틀 온더고 세트" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="1-018">
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 6%;">
            ...
            <p class="fs-3 fw-medium mb-4">세트로 만나보는 커피 한 잔의 여유</p>
            <p class="mb-5" style="line-height: 30px;">
               	 블루보틀의 감성을 하나로 담은 시그니처 박스 세트를<br>
               	 소개합니다. 풍부한 향과 깊은 맛을 간직한 크래프트 인스턴트<br>
               	 커피 에스프레소, 그리고 실용성과 디자인을 모두 갖춘 화이트<br>
               	 트래블 머그 20oz를 블루보틀의 시그니처 박스에 정성스럽게<br>
               	 담았습니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/on-the-go-set_D2_PC_04056ad1-6f76-4d41-8f73-8c5ee1e93b65.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/set_D3_PC.webp" alt="" />
    </div>
