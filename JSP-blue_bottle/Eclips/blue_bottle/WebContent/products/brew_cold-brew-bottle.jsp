...
<html lang="en">
  <head>
    ...
    <title>콜드브루 보틀 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/Hario-Cold-Brew-Bottle-Blue-M1-Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 6%;">
            <p class="fs-3 fw-medium mb-4">콜드브루 보틀</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	분쇄한 원두, 깨끗한 물을 준비하고 8~12시간만 기다려<br>
            	주세요. 그러면 블루보틀 콜드브루 보틀로 집에서도<br>
            	간편하고 훌륭한 콜드브루를 즐길 수 있습니다. 잠들기 전<br>
            	냉장고에 넣어 두고 아침에 꺼내어 내가 만든 커피와 함께<br>
            	깔끔하고 산뜻한 하루를 시작해 보세요.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	커피 추출량 기준 650ML의 사이즈로 넉넉한 용량을<br>
            	갖추었으며, 블루 또는 그레이 컬러를 선택할 수 있습니다.<br>
            	블루보틀 로고는 그레이 컬러 상품에만 새겨져 있습니다.
            </p>
                    ...
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">콜드브루 보틀</span>
                                    <span class="text-muted mt-1 ms-5">₩<span id="unit-price">35,000</span></span>
                                </div>
                            ...
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="콜드브루 보틀" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="3-007">
                            <input type="hidden" name="img_src" value="../products/images/Hario-Cold-Brew-Bottle-Blue-M1-Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 7%;">
            <p class="fw-medium">디자인 스토리</p>
            <p class="fs-3 fw-medium mb-4">간편하게 만드는 콜드브루</p>
            <p class="mb-5" style="line-height: 30px;">
               	 초미세 필터로 맑고 침전물 거의 없는 커피를 만들 수<br>
               	 있습니다. 그저 시원하고 산뜻한 커피를 즐기는 데에만 집중할<br>
               	 수 있죠. 블루보틀 카페에서 경험 하신 콜드브루를 매일<br>
               	 집에서도 간편하게 즐기고 싶다면 콜드브루 보틀은 최고의<br>
               	 선택이 되어 줄 거에요.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Hario-Cold-Brew-Bottle-Grey-M3-Design-Detail1.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/Hario-Cold-Brew-Bottle-Blue-M4-Lifestyle-Desktop.webp" alt="" />
    </div>
