...
<html lang="en">
  <head>
    ...
    <title>블루보틀 커피 카라페 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/Coffee-Carafe-M1-Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">블루보틀 커피 카라페(500ml)</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀 카페를 방문해 보신 분이라면 이 카라페를 본<br>
            	적이 있을 거예요. 뉴욕부터 서울까지, 블루보틀의 모든<br>
            	카페에서 커피 카라페를 사용해 푸어 오버를 완성합니다.<br>
            	사용하기 편리하고 아름다운 디자인을 갖춘 카라페는<br>
            	500ml 용량의 넉넉한 사이즈입니다. 드리퍼와 하단이 맞는<br>
            	사이즈로 커피를 내린 뒤 우아하게 한 잔의 커피를 따를 수<br>
            	있습니다. 카라페와 함께 여러분의 커피 타임을<br>
            	완성해보세요.
            </p>
                    ...
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">블루보틀 커피 카라페(500ml)</span>
                            ...
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="블루보틀 커피 카라페(500ml)" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="3-006">
                            <input type="hidden" name="img_src" value="../products/images/Coffee-Carafe-M1-Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 8%;">
            ...
            <p class="fs-3 fw-medium mb-4">우아하고 품위 있는 한 잔의 완성</p>
            <p class="mb-5" style="line-height: 30px;">
               	 블루보틀 커피 카라페는 블루보틀 카페에서 커피의 아름다움을<br>
               	 보여드릴 수 있도록 디자인 되었습니다. 이제 집에서도 멋진<br>
               	 카라페와 함께 한 잔의 커피를 완성해 보세요.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Coffee-Carafe-M3-Design-Detail1-Desktop.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/Coffee-Carafe-M4-Lifestyle-Desktop.webp" alt="" />
    </div>
