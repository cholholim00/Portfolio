...
<html lang="en">
  <head>
    ...
    <title>스톤 플레이트 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/M1_MoheimStonePlate_Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">스톤 플레이트</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	디저트나 가벼운 요리를 담기에 적합한 실용적인 사이즈로,<br>
            	독특한 질감이 어떤 음식을 담아도 아름답게 돋보이게<br>
            	합니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	군더더기 없는 그레이 색상은 다양한 키친웨어와<br>
            	자연스럽게 어우러지며, 특히 블루보틀 스톤 머그와 함께<br>
            	사용할 경우 완벽한 조화를 이룹니다. 겉면은 매트한<br>
            	질감을 자랑하며 내부는 유광 처리되어 두 질감의 대비가<br>
            	돋보입니다. 이 조화로운 디자인은 차분함과 세련됨을<br>
            	동시에 전달하며, 어떤 식탁에서도 눈길을 사로잡습니다.
            </p>
                    ...
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">스톤 플레이트</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">28,000</span></span>
                                </div>
                            ...
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="스톤 플레이트" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="4-008">
                            <input type="hidden" name="img_src" value="../products/images/M1_MoheimStonePlate_Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 5%;">
            ...
            <p class="fs-3 fw-medium mb-4">장인 정신을 담은 플레이트</p>
            <p class="mb-5" style="line-height: 30px;">
               	 베트남의 장인들이 정교하게 제작한 이 플레이트는 외부의<br>
               	 매트한 유약과 내부의 광택 있는 표면의 대비가 묵직함을<br>
               	 더하면서도 섬세한 손길을 제공합니다. 핸드메이드의 특징인<br>
               	 질감과 유약의 미세한 변형이 각 접시마다 독특하고 매력적인<br>
               	 개성을 부여합니다. 일상적인 용도와 특별한 행사에 모두<br>
               	 적합하며, 전통과 현대적인 스타일이 조화를 이루어 어떤<br>
               	 테이블 세팅도 한층 더 품격 있게 만들어줍니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/M2_MoheimStonePlate_Desktop.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
