...
<html lang="en">
  <head>
    ...
    <title>클리어 콜드 텀블러 16oz (454ml) - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/Clear-Cold-Tumbler-M1-Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">클리어 콜드 텀블러 16oz (454ml)</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀의 아이스 음료 전용 텀블러인 클리어 콜드<br>
            	텀블러를 만나보세요. 
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	호주 브랜드 킵컵 (KeepCup)과 협업하여 탄생한 차가운<br>
            	음료 전용 텀블러로 높은 투명도와 내구성이 강한 트라이탄<br>
            	(Tritan) 소재로 제작되어 여러 차례 재사용할 수<br>
            	있습니다. 
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	대부분의 차량 컵홀더에도 적합한 사이즈로 언제 어디서나<br>
            	시원한 음료를 즐겨보세요.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \44,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">클리어 콜드 텀블러 16oz (454ml)</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">44,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">44,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">44,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="클리어 콜드 텀블러 16oz (454ml)" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="2-002">
                            <input type="hidden" name="img_src" value="../products/images/Clear-Cold-Tumbler-M1-Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 5%;">
            ...
            <p class="fs-3 fw-medium mb-4">완벽한 여름을 위한 텀블러</p>
            <p class="mb-5" style="line-height: 30px;">
               	 음료가 흐르는 부분을 방지하는 뚜껑을 사용하여 휴대성을 높였으며,<br>
               	 대부분의 자동차 컵 홀더에 맞도록 설계되었습니다. 언제 어디서나<br>
               	 클리어 콜드 텀블러와 함께 해 보세요.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	제조사 킵컵(KeepCup)과 협업하여 탄생한 텀블러로 재활용 가능한<br>
                	트라이탄 소재로 만들었습니다. 다양한 활동에 함께 하기 좋은
                	내구성을 갖추었습니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	텀블러의 투명함을 오래 유지하고 텀블러와 뚜껑의 긁힘 방지를 위해<br>
                	부드러운 스펀지를 사용하여 약하게 손 세척해주세요.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Clear-Cold-Tumbler-M2-Desktop.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/Clear-Cold-Tumbler-M3-Desktop_84f2e244-276c-4a99-90d7-bfa4251f37fe.webp" alt="" />
    </div>
