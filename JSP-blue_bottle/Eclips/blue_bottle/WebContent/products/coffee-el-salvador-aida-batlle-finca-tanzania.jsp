...
<html lang="en">
  <head>
    ...
    <title>엘사바도르 아이다 바틀레 핀카 탄자니아 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/D1_1600x1600_05168e2f-1165-469c-988d-8132e256632a.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">엘사바도르 아이다 바틀레<br>핀카 탄자니아</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	세계적인 커피 생산자 아이다 바틀레가 블루보틀을 위해<br>
            	직접 선별한 핀카 탄자니아 커피를 소개합니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	엘살바도르의 내추럴 가공 방식으로 완성된 이 커피는<br>
            	감귤류의 산미와 황설탕, 다크 초콜릿의 깊은 풍미가<br>
            	조화를 이룹니다. 맑고 균형 잡힌 맛으로, 일상의 여백을<br>
            	부드럽게 채워주는 한 잔입니다.
            </p>
                    ...
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">엘사바도르 아이다 바틀레 핀카 탄자니아</span>
                            ...
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="엘사바도르 아이다 바틀레 핀카 탄자니아" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="1-010">
                            <input type="hidden" name="img_src" value="../products/images/D1_1600x1600_05168e2f-1165-469c-988d-8132e256632a.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 2%;">
            ...
            <p class="fs-3 fw-medium mb-4" style="text-align: center;">브라운 버터,메이플 시럽,말린 자두</p>
            <br><br>
        ...
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/El-Salvador-Aida-Batlle-Finca-Tanzania-Detail-Desktop.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-bottom: 11%;">
            <img src="./images/El-Salvador-Aida-Batlle-Finca-Tanzania-Origin.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
        <div class="col" style="padding-top: 2%;">
            <p class="fw-medium">지역 및 파트너</p>
            <p class="fs-3 fw-medium mb-4">품질을 향한 집념, 한 잔의 커피로</p>
            <p class="mb-5" style="line-height: 30px;">
                	엘살바도르 산타아나의 가파른 산악 지대에 자리한 핀카<br>
                	탄자니아는 극한의 자연과 보안 위협 속에서도 커피를<br>
                	재배하는 특별한 농장입니다. 지역 농부들의 과일나무<br>
                	사이에서 자라는 커피나무는, 커피 잎녹병과 같은 어려움<br>
                	속에서도 아이다 바틀레의 헌신 아래 섬세하고 달콤한 풍미로<br>
                	피어납니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	아이다는 체리 수확부터 실험적인 가공까지 모든 과정에 직접<br>
                	관여하며, 동아프리카에서 영감을 받은 다양한 방식들을<br>
                	도입해왔습니다. 특히 중앙 아메리카에서 고품질 내추럴 커피<br>
                	생산의 선구자로, 케냐와 브룬디 스타일 워시드 가공법도<br>
                	그녀의 손끝에서 완성됩니다.
            </p>
        </div>
    </div>
