...
<html lang="en">
  <head>
    ...
    <title>하리오 우드 주전자 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/D1_1600x1600_20250116_717d8b2e-d942-46b7-92b9-9c5735d46523.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">하리오 우드 주전자</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	하리오 우드 주전자는 심플한 디자인에 우드 디테일을 더해<br>
            	따뜻하고 아늑한 분위기를 선사합니다. 입구 부분은 물을<br>
            	부을 때 편리하도록 이상적인 곡선을 갖췄으며, 알파벳<br>
            	'r'을 닮은 손잡이는 안정적인 그립감을 제공합니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	손잡이와 뚜껑의 우드 포인트가 따뜻한 무드를 더해주는<br>
            	하리오 우드 주전자는 아름다움과 실용성을 겸비한<br>
            	제품입니다. 일상에 자연스러운 감성을 더해 보세요.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \78,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">하리오 우드 주전자</span>
                                    <span class="text-muted mt-1 ms-5">₩<span id="unit-price">78,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">78,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">78,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="하리오 우드 주전자" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="3-004">
                            <input type="hidden" name="img_src" value="../products/images/D1_1600x1600_20250116_717d8b2e-d942-46b7-92b9-9c5735d46523.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 2%;">
            ...
            <p class="fs-3 fw-medium mb-4">실용성과 디자인의 만남</p>
            <p class="mb-5" style="line-height: 30px;">
               	 1921년 일본에서 설립된 하리오는 ‘유리의 제왕’이라 불릴<br>
               	 만큼 오랜 시간 동안 유리를 연구하며 완성도를 높여온<br>
               	 브랜드입니다. 장인 정신을 바탕으로 제작된 하리오의 유리<br>
               	 제품은 뛰어난 강도와 내열성을 자랑하며, 주방 용품뿐만<br>
               	 아니라 다양한 커피 도구에서도 그 가치를 인정받고 있습니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	전 세계 커피 대회와 유명 로스터리 카페에서도 사용되는<br>
                	하리오의 제품은 초보 홈 바리스타부터 전문가까지, 누구나<br>
                	신뢰하는 커피 브랜드로 자리 잡았습니다. 하리오는 커피<br>
                	전문가들과 협력하며 가정에서도 손쉽게 맛있는 커피를 즐길<br>
                	수 있도록 끊임없이 연구하며, 더 나은 커피 경험을 위한<br>
                	도전을 계속해 나가고 있습니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/D2_PC_20250116_04726383-465b-4d7b-a51e-5f52e8212520.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
