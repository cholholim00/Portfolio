...
<html lang="en">
  <head>
    ...
    <title>엠브로이더리 에코 백 -커피리프- - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/M1_EmbroideredTote_Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">엠브로이더리 에코 백<br>-커피 리프-</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	차분한 그레이 컬러에 블루보틀 로고 자수가 더해진<br>
            	감각적인 에코백으로, 생활 방수 기능과 탄탄한 소재로<br>
            	실용성을 더했습니다. 넉넉한 수납력과 접을 수 있는<br>
            	휴대성까지 갖춰, 일상 어디서든 편안하게 사용할 수 있는<br>
            	데일리 백입니다.
            </p>
                    ...
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">엠브로이더리 에코 백 -커피 리프-</span>
                            ...
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="엠브로이더리 에코 백 -커피 리프-" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="4-001">
                            <input type="hidden" name="img_src" value="../products/images/M1_EmbroideredTote_Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 3%;">
            ...
            <p class="fs-3 fw-medium mb-4">은은한 감도의 색채</p>
            <p class="mb-5" style="line-height: 30px;">
               	 블루보틀을 위해 특별히 염색된 그레이 컬러에 섬세한 자수<br>
               	 디테일이 더해진 감각적인 에코백입니다. 생활 방수가 가능한<br>
               	 튼튼한 폴리에스터 소재로 제작되어, 다양한 날씨 속에서도<br>
               	 안심하고 사용할 수 있습니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	넓은 입구와 여유 있는 수납 공간으로 실용성을 높였으며,<br>
                	부피가 큰 소지품도 손쉽게 담을 수 있습니다. 필요할 땐<br>
                	가볍게 접어 휴대할 수 있어, 일상에 꼭 맞는 데일리 백으로<br>
                	추천드립니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/M2_EmbroideredTote_Desktop.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
