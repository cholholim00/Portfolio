...
<html lang="en">
  <head>
    ...
    <title>블루보틀 푸어 오버 키트 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/Blue-Bottle-Pour-Over-Kit-M1-Component-Detail_33a04dbb-0db8-4406-8655-adf975529cc2.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">블루보틀 푸어 오버 키트</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀 카페에서 즐기던 섬세한 풍미를 집에서도 그대로<br>
            	즐길 수 있도록 블루보틀 푸어 오버 키트를 여러분께<br>
            	제안합니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	이 푸어 오버 키트에는 과학적으로 설계된 드리퍼, 특별<br>
            	제작된 유리 카라페, 그리고 30장의 블루보틀 필터가<br>
            	포함되어 있습니다. 전문가처럼 완벽하게 맛있는 커피 한<br>
            	잔을 내릴 수 있도록 돕습니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	드리퍼에 취향에 맞는 원두를 골라 특별한 푸어 오버를<br>
            	완성해보세요. 커피 애호가 친구 혹은 소중한 분을 위한<br>
            	선물로도 추천합니다.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \49,700</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">블루보틀 푸어 오버 키트</span>
                                    <span class="text-muted mt-1 ms-5">₩<span id="unit-price">49,700</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">49,700</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">49,700</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="블루보틀 푸어 오버 키트" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="3-003">
                            <input type="hidden" name="img_src" value="../products/images/Blue-Bottle-Pour-Over-Kit-M1-Component-Detail_33a04dbb-0db8-4406-8655-adf975529cc2.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 3%;">
            ...
            <p class="fs-3 fw-medium mb-4">집에서 즐기는 블루보틀 푸어 오버</p>
            <hr style="width: 75%;">
            <p class="mb-5" style="line-height: 30px;">
               	 정교하게 디자인 된 도자기 소재로 푸어 오버를 하는 동안 온도를<br>
               	 유지해주며 균일하게 커피를 흐를 수 있도록 고안 되었습니다.
            </p>
            <hr style="width: 75%;">
            <p class="mb-5" style="line-height: 30px;">
                	사용하기 편리하고 아름다운 디자인을 갖춘 카라페는 500ml 용량의<br>
                	넉넉한 사이즈입니다. 드리퍼와 하단이 맞는 사이즈로 커피를 내린 뒤<br>
                	우아하게 한 잔의 커피를 따를 수 있습니다.
            </p>
            <hr style="width: 75%;">
            <p class="mb-5" style="line-height: 30px;">
                	대나무 펄프의 종이 필터로, 완벽한 커피 한 잔을 완성하기 위해<br>
                	블루보틀 커피 드리퍼와 함께 사용하시는 것을 추천합니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Blue-Bottle-Pour-Over-Kit-M3-Design-Detail1_0240eb24-b08a-47ef-94c5-822a7cbe52a6.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
