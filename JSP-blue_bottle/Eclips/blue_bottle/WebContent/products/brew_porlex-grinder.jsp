...
<html lang="en">
  <head>
    ...
    <title>포렉스(Porlex) 미니 그라인더 Ⅱ - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/Porlex-Mini-Grinder-II-M1-Hero_9279346a-9689-4723-ba64-edda2ebd3900.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">포렉스(Porlex) 미니 그라인더 Ⅱ</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	한 손에 쥐고 그라인딩할 수 있는 아담한 사이즈의 포렉스<br>
            	미니 그라인더 II는 견고한 스테인레스 스틸로 제작되어<br>
            	오랜 기간 사용할 수 있습니다. 균일한 분쇄 입자를 유지할<br>
            	수 있어 훌륭한 커피 한 잔을 만들기 위한 조력자가<br>
            	되어줍니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	집에서는 물론 밖에서도 훌륭한 커피를 마시고 싶을 때,<br>
            	간편한 포렉스 미니 그라인더 II를 휴대해보세요. 캠핑이나<br>
            	로드 트립을 떠날 때, 언제 어디서나 제대로 된 커피 한<br>
            	잔을 완성할 수 있습니다. 수동 그라인더입니다.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \85,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">포렉스(Porlex) 미니 그라인더 Ⅱ</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">85,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">85,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">85,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="포렉스(Porlex) 미니 그라인더 ll" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="3-010">
                            <input type="hidden" name="img_src" value="../products/images/Porlex-Mini-Grinder-II-M1-Hero_9279346a-9689-4723-ba64-edda2ebd3900.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 3%;">
            ...
            <p class="fs-3 fw-medium mb-4">고품질의 휴대용 그라인더</p>
            <p class="mb-5" style="line-height: 30px;">
               	 휴대성을 강조한 디자인으로, 그라인더의 핸들을 분리하여 보관할 수<br>
               	 있습니다. (사이즈 H 135 mm)
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	안정적이고 일정한 분쇄가 가능하며, 톱니 바퀴 모양의 나사를 시계<br>
                	방향으로 돌릴 수록 가늘게 분쇄가 되도록 설계되어 익숙하지 않은<br>
                	분들도 쉽게 굵기를 조정할 수 있습니다.(분쇄도 조정: 1클릭<br>
                	=0.125mm / 8클릭 = 1mm 차이)
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	튼튼한 내구성으로 정전기가 거의 나지 않으며, 한번에 커피 20g을<br>
                	담을 수 있는 내구성 강한 스테인리스 스틸 바디를 사용했습니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Porlex-Mini-Grinder-II-M3-Design-Detail1.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/Porlex-Mini-Grinder-II-M4-Lifestyle-Desktop.webp" alt="" />
    </div>
