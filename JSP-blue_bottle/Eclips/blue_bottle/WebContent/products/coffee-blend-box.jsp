...
<html lang="en">
  <head>
    ...
    <title>시그니쳐 블렌드 세트 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/D1_1600x1600_Signature_Blends_Set_edited.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">시그니쳐 블렌드 세트</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀은 커피 한 잔에서 완성되는 조화로운 맛을 위해<br>
            	두세 가지의 원두를 선별하여 블렌드를 선보입니다. 이렇게<br>
            	탄생한 블렌드는 다양한 지역과 기후 그리고 디자인된<br>
            	로스팅 방식을 통해 편안하면서도 새로움을 선사합니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블렌드 세트에는 블루보틀에서 가장 인기 있으면서 특색이<br>
            	다른 세가지 블렌드인 벨라 도노반, 쓰리 아프리카스,<br>
            	자이언트 스텝스가 각각 100g씩 담겨 있습니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	나를 위한, 가까운 분들을 위한 커피로 추천합니다. 다양한<br>
            	커피와 함께 매일 새로운 하루를 시작해 보세요.
            </p>
                    ...
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">시그니쳐 블렌드 세트</span>
                            ...
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="시그니쳐 블렌드 세트" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="1-007">
                            <input type="hidden" name="img_src" value="../products/images/D1_1600x1600_Signature_Blends_Set_edited.webp" />
    ...
    <div class="row">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-bottom: 11%;">
            <img src="./images/D1_1000x1250_Signature_Blends_Set_edited.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
        <div class="col" style="padding-top: 4%;">
            <p class="fw-medium">디자인 스토리</p>
            <p class="fs-3 fw-medium mb-4">다양하게 즐기는 커피</p>
            <p class="mb-5" style="line-height: 30px;">
                	가장 초창기에 출시된 블렌드 중 하나로, 편안하고 포근한 마치<br>
                	캐시미어 스웨터 같은 커피입니다. 최초의 대중적인 블렌드로 이름을<br>
                	알린 모카 자바에서 영감을 얻었습니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	블루보틀 블렌드 중 가장 화사한 원두 중 하나로, 에티오피아 내추럴<br>
                	커피의 농밀한 과일향, 워시드 에티오피아의 기분 좋은 산미 그리고<br>
                	균형 잡힌 바디감과 단맛을 느낄 수 있습니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	농후한 초콜릿 향미와 다크 카라멜의 노트를 가진 블루보틀 블렌드 중<br>
                	가장 볼드한 원두입니다. 블랙커피로 마시거나 우유를 더해 다양하게<br>
                	즐겨보세요.
            </p>
        </div>
    </div>
