...
<html lang="en">
  <head>
    ...
    <title>커먼 콜드 드링크 글라스 2잔 세트 (각 350ml) - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/M1_AromaGlassSet.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">커먼 콜드 드링크 글라스<br>2잔 세트 (각 350ml)</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	350ml 사이즈의 콜드 드링크 글라스 2잔 세트는 일상 적인<br>
            	모든 음료에 보는 즐거움을 더하기 위해 탄생했습니다.<br>
            	넉넉한 둘레로 커피는 물론 시원한 물 한 잔도 더욱 맛있게<br>
            	즐길 수 있습니다. 은은한 블루보틀 로고가 잔에 음료를<br>
            	더했을 때 더욱 풍부하게 색상을 드러냅니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	맛있는 커피를 담아 마주 앉은 분들과 즐거운 대화를<br>
            	시작해 보세요.
            </p>
            ...
            <form action="./insertCart.jsp?idx=1" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \40,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">커먼 콜드 드링크 글라스 2잔 세트 (각 350ml)</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">40,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">40,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">40,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="커먼 콜드 드링크 글라스 2잔 세트 (각 350ml)" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="2-031">
                            <input type="hidden" name="img_src" value="../products/images/M1_AromaGlassSet.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 8%;">
            ...
            <p class="fs-3 fw-medium mb-4">간결함에서 받은 영감</p>
            <p class="mb-5" style="line-height: 30px;">
               	 단순함에서 영감을 받은 글라스 세트로 일상에 우아함을<br>
               	 더합니다. 다양하게 활용할 수 있는 간결한 디자인으로<br>
               	 가정에서도 여유로운 블루보틀의 무드를 즐길 수 있습니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/M2_AromaGlassSet_Desktop.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/M3_AromaGlassSet_Desktop.webp" alt="" />
    </div>
