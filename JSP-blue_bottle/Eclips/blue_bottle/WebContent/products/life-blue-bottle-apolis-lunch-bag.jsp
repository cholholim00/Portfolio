...
<html lang="en">
  <head>
    ...
    <title>런치백 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/D1_1600x1600_20250116.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">런치백</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀 런치백은 지속 가능한 성장을 추구하는 브랜드<br>
            	아폴리스와의 협업으로 탄생한 제품으로, 100% 천연 황마<br>
            	소재의 자연스러운 질감을 살렸습니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀이 시작된 오클랜드, 캘리포니아를 담아낸 텍스트<br>
            	디자인이 캐주얼한 매력을 더하며 실용적인 사이즈로<br>
            	다양하게 활용할 수 있습니다.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \70,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">런치백</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">70,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">70,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">70,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="런치백" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="4-006">
                            <input type="hidden" name="img_src" value="../products/images/D1_1600x1600_20250116.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        ...
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/D2_PC_20250116.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
