...
<html lang="en">
  <head>
    ...
    <title>블루보틀 커피 필터 - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/Blue-Bottle-Coffee-Filters-M1-Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">블루보틀 커피 필터</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	대나무 펄프의 종이 필터로 블루보틀의 홈 브루잉을<br>
            	완성해보세요. 완벽한 커피 한 잔을 완성하기 위해서는<br>
            	블루보틀 커피 드리퍼와 함께 사용하시는 것을<br>
            	추천합니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀은 2000년대 초부터 지금까지 푸어 오버 방식을<br>
            	면밀히 개선해 왔습니다. 블루보틀의 이 특별한 커피 필터<br>
            	디자인은 공학 엔지니어들이 70개의 프로토타입을 만들어<br>
            	1년간 집중 연구한 결과 입니다. 블루보틀 카페에서<br>
            	사용하는 커피 필터로써 블루보틀이 추구하는 완벽한 커피<br>
            	한 잔을 만들기 위한 필수 요소가 되었습니다. 
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <select class="form-select mb-3" aria-label="Default select example" style="width: 57%; height: 48px;" name="option">
                    ...
                    <option value="90Pcs">90 Pcs</option>
                </select>
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \5,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">블루보틀 커피 필터</span>
                                    <span class="text-muted mt-1 ms-5">₩<span id="unit-price">5,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">5,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">5,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="블루보틀 커피 필터" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="3-008">
                            <input type="hidden" name="img_src" value="../products/images/Blue-Bottle-Coffee-Filters-M1-Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 4%;">
            ...
            <p class="fs-3 fw-medium mb-4">신뢰할 수 있는 특별한 필터</p>
            <p class="mb-5" style="line-height: 30px;">
               	 블루보틀 커피 드리퍼와 꼭 맞게 설계된 필터는 일반적인<br>
               	 필터의 종이 향이 남지 않아 오로지 커피가 가지고 있는 맛을<br>
               	 살릴 수 있게 해 줍니다. 뜨거운 물로 헹구는 린싱 작업이<br>
               	 불필요하며, 이음 없이 드리퍼 모양과 닮은 특별한 주름은<br>
               	 집에서도 어렵지 않게 훌륭한 커피를 만들 수 있도록<br>
               	 도와줍니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	블루보틀 커피 드리퍼와 세트로 구입하여 근사한 홈카페를<br>
                	꾸며보세요.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Blue-Bottle-Coffee-Filters-M3-Design-Detail1.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/Blue-Bottle-Coffee-Filters-M4-Lifestyle-Desktop.webp" alt="" />
    </div>
