...
<html lang="en">
  <head>
    ...
    <title>블루보틀 머그 (341ml) - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%; margin-top: 2%;">
            <img src="./images/Blue-Bottle-Claska-Mug-M1-Hero_5e49d339-8eac-45a0-a595-ca5d263cc81b.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">블루보틀 머그 (341ml)</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	어떤 머그컵에 손이 자주 가시나요? 균형감이 돋보이는<br>
            	사이즈의 손잡이, 적절한 양의 커피가 담기는 크기의<br>
            	머그잔을 들고 따스한 아침을 맞이하는 모습을<br>
            	떠올려보세요.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	블루보틀 머그는 이러한 모습을 떠올리게 합니다. 간결하고<br>
            	정교하면서도 옅은컬러와 완만한 곡선형의 디자인으로<br>
            	부드러운 감각을 느낄 수 있습니다. 하단으로 갈수록<br>
            	넓어지는 형태로 따뜻한 음료를 좀 더 오래 즐길 수 있으며<br>
            	음료의 향미를 더 오래 담아두어 마지막 한 모금까지<br>
            	충분히 즐길 수 있도록 돕습니다. 블루보틀 머그와 함께 내<br>
            	집처럼 편안하고 포근한 기분을 느껴보세요. 
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \26,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">블루보틀 머그 (341ml)</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">26,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">26,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">26,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="블루보틀 머그 (341ml)" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="2-022">
                            <input type="hidden" name="img_src" value="../products/images/Blue-Bottle-Claska-Mug-M1-Hero_5e49d339-8eac-45a0-a595-ca5d263cc81b.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 5%;">
            ...
            <p class="fs-3 fw-medium mb-4">단순함에 대한 고찰</p>
            <p class="mb-5" style="line-height: 30px;">
               	 블루보틀 머그는 간결한 라인과 부드러운 색상으로 부드러운<br>
               	 표면 처리와 섬세한 곡선으로 미니멀한 디자인 철학을<br>
               	 담았습니다.
            </p>
            <hr style="width: 80%">
            <div class="row mt-5">
            	<div class="col-2 ms-4 mt-3">
            		<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-cup" viewBox="0 0 16 16">
            	...
            	<div class="col">
            		<p class="mb-5" style="line-height: 30px; font-size: 12px; font-weight: bold;">
	               	 용량: 12oz (341 ML)<br>
	               	 원산지: 일본<br>
	               	 사용법: 중성세제로 손 세척 가능 (식기세척기 불가)
            		</p>
            	</div>
            </div>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/3238c49c8e2f763ef7ac98c273ab77b7.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/Blue-Bottle-Claska-Mug-M4-Lifestyle-Desktop.webp" alt="" />
    </div>
