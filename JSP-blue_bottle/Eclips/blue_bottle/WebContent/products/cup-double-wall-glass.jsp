...
<html lang="en">
  <head>
    ...
    <title>더블월 글라스 (390ml) - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/Blue-Bottle-Bodum-Mug-M1-Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">더블월 글라스 (390ml)</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	투명한 컵으로 유니크한 더블월 시스템으로 음료가 떠 있는<br>
            	듯한 시각적인 아름다움과 더불어 시원한 음료를 담았을때<br>
            	겉에 물방울 맺힘이 거의 없어 깔끔하게 음료를 즐길 수<br>
            	있도록 돕습니다. 10oz (390ml) 사이즈의 글라스 컵으로<br>
            	따뜻한 커피는 물론 콜드브루 등 차가운 음료에도 사용하기<br>
            	좋습니다. 블루보틀 로고가 중앙에 장식되어 감각적인<br>
            	디자인을 더합니다.
            </p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \39,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">더블월 글라스 (390ml)</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">39,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">39,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">39,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="더블월 글라스 (390ml)" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="2-033">
                            <input type="hidden" name="img_src" value="../products/images/Blue-Bottle-Bodum-Mug-M1-Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 8%;">
            ...
            <p class="mb-5" style="line-height: 30px;">
               	 이중벽 디자인으로 컵이 너무 뜨겁거나 차가워지는 것을<br>
               	 방지하며 손잡이가 추가되어 편안하게 사용할 수 있습니다.<br>
               	 투명한 색상과 블루보틀 로고, 그리고 적정한 사이즈로 커피의<br>
               	 모든 요소를 즐기기에 완벽합니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Blue-Bottle-Bodum-Mug-M3-Design-Detail-Desktop.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
