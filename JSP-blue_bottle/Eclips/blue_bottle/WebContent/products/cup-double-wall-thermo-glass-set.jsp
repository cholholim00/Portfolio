...
<html lang="en">
  <head>
    ...
    <title>더블월 써모 글라스 세트 (각 350ml) - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/Bodum-Double-Wall-Glass-Thermo-Glasses-M1-Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">더블월 써모 글라스 세트<br>(각 350ml)</p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	더블월 써모 글라스 세트는 350ml 용량의 두 개의 컵으로<br>
            	구성되어 있습니다. 더블월 디자인으로 마치 음료가 공중에<br>
            	떠 있는 듯한 시각적인 아름다움과 더불어 시원한 음료를<br>
            	담았을때 물방울 맺힘이 거의 없어 시원하고 깔끔하게<br>
            	음료를 즐길 수 있도록 돕습니다.
            </p>
            <p class="mb-3" style="font-size: 13px; line-height: 25px;">
            	콜드브루, 라떼 등 다양한 음료를 아름다운 잔에 담아 즐길<br>
            	수 있습니다. 투명한 컵에 더해진 블루보틀 로고가<br>
            	디자인을 더욱 돋보이게 합니다.
            </p>
                    ...
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">더블월 써모 글라스 세트 (각 350ml)</span>
                            ...
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="더블월 써모 글라스 세트 (각 350ml)" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="2-032">
                            <input type="hidden" name="img_src" value="../products/images/Bodum-Double-Wall-Glass-Thermo-Glasses-M1-Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 8%;">
            <p class="fw-medium">디자인 스토리</p>
            <p class="fs-3 fw-medium mb-4">커피와 함께하는 모든 순간</p>
            <p class="mb-5" style="line-height: 30px;">
               	 수정처럼 맑고 투명한 더블월 써모 글라스 세트는 여러분이<br>
               	 커피의 모든 요소를 즐기기에 적합한 아이템입니다. 커피의<br>
               	 색상을 눈으로 보고 향과 맛을 음미하며 묵직함을 느끼는<br>
               	 것까지 완벽합니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
               	 넉넉한 용량으로 커피와 얼음을 넣기에 적당한 사이즈이면서<br>
               	 적절한 폭으로 한 손으로도 들 수 있습니다. 유리 손상의<br>
               	 방지를 위해 얼음은 항상 부드럽게 넣어주세요.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Bodum-Double-Wall-Glass-Thermo-Glasses-M2-Desktop.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>

    <!-- 로스팅 프로필 -->
    <div class="row">
        <img src="./images/Bodum-Double-Wall-Glass-Thermo-Glasses-M4-Desktop.webp" alt="" />
    </div>
