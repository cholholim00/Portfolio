...
<html lang="en">
  <head>
    ...
    <title>클리어 콜드 텀블러 20oz (591ml) - BLUE BOTTLE COFFEE KOREA</title>
  ...
  <body>
    ...
    <div class="row mt-0 my_product">
        <div class="col" style="margin-left: 6%; margin-right: 5%; margin-bottom: 15%;">
            <img src="./images/M1_ClearColdTumbler20oz_Hero.webp" alt="" class="" style="width: 720px; height: 700px;">
        </div>
        <div class="col" style="padding-top: 9%;">
            <p class="fs-3 fw-medium mb-4">클리어 콜드 텀블러 20oz (591ml)</p>
            ...
            <form action="./insertCart.jsp?idx=<%=user_idx %>" method="post" onsubmit="checkLoginAndSubmit(); updatePrices();">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <!-- 카트에 추가 버튼 -->
                    <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="width: 57%; height: 48px;">카트에 추가 | \47,000</button>
                    <!-- 버튼 클릭 시 offcanvas -->
                    <div class="offcanvas offcanvas-end my_offcanvas" tabindex="-1" id="offcanvasRight" style="width: 620px;">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #faf6ee;">
                                <div>
                                    <span class="mb-1 me-5 fw-bold">클리어 콜드 텀블러 20oz (591ml)</span>
                                    <span class="text-muted mt-1 ms-4">₩<span id="unit-price">47,000</span></span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <span>예상 총액</span>
                                <span>₩<span id="subtotal">47,000</span></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between fw-bold mb-4">
                                <span>총 결제 금액</span>
                                <span>₩<span id="total">47,000</span></span>
                                <!-- price -->
                                <input type="hidden" id="total-input" name="price" value="">
                            </div>
                            <!-- 결제 버튼 -->
                            <!-- name -->
                            <input type="hidden" name="name" value="클리어 콜드 텀블러 20oz (591ml)" />	
                            <!-- product_idx -->
                            <input type="hidden" name="product_idx" value="2-001">
                            <input type="hidden" name="img_src" value="../products/images/M1_ClearColdTumbler20oz_Hero.webp" />
    ...
    <div class="row" style="margin-top: 12%; margin-bottom: 11%;">
        <div class="col" style="margin-left: 8%; margin-right: 5%; margin-top: 5%;">
            ...
            <p class="fs-3 fw-medium mb-4">여름을 더 시원하고 지속 가능하게</p>
            <p class="mb-5" style="line-height: 30px;">
               	 높은 투명도와 강한 내구성의 트라이탄 소재로 만든 클리어<br>
               	 콜드 텀블러는 수백만 개의 일회용 컵 절감을 이끈 킵컵에서<br>
               	 제작한 지속 가능한 선택입니다. 블루보틀 디자인 감성을<br>
               	 그대로 담아, 시그니처 블루 로고와 음료의 색감이 선명하게<br>
               	 대비됩니다.
            </p>
            <p class="mb-5" style="line-height: 30px;">
                	20oz로 넉넉해진 사이즈로 여러 차례 재사용할 수 있어,<br>
                	올여름 시원한 무드와 실용성을 동시에 만족시켜 줍니다.
            </p>
        </div>
        <div class="col" style="margin-left: 0; margin-right: 8%;">
            <img src="./images/Hover_ClearColdTumbler20oz.webp" alt="" class="" style="width: 580px; height: 550px;">
        </div>
    </div>
