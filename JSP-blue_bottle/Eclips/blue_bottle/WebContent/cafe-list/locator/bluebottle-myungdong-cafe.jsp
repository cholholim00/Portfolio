...
<body>
    ...
    <div class="container-fluid py-5 px-lg-5 px-4 nt_font">
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">서울 중구 명동길 14 1층</p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <strong class="mb-2">운영시간</strong>
                        <p class="mb-3">평일: 07:30 - 22:00 │ 주말: 08:00 - 22:00</p>
                    </div>
                </div>
            ...
            <div class="row map-container mt-4 g-0 pb-5 px-lg-4 px-2">
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                       <p class="pb-3 text-start">
				           ‘블루 하우스'로 불리는 명동 카페는 방안에 앉아 내 집의 경치를 감상할 수 있는 
				           ‘자경(自景)‘을 모티브하여 집을 콘셉트로 디자인한 '온더고(on the go)' 카페입니다. 
				                            바쁜 도심 속 잠시의 휴식을 취해 보세요.
                        </p>
                        <a href="https://naver.me/Fnm0NR77" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/bluebottle-myungdong-cafe/img01.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-myungdong-cafe/img02.webp">               
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-myungdong-cafe/img03.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-myungdong-cafe/img04.webp">
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.5634116488196, 126.98288772495), // 명동 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(37.5634116488196, 126.98288772495),
		    map: map,
		    title: "블루보틀 명동 카페",
		    icon: {
		    	url: 'mapIcon.png',
