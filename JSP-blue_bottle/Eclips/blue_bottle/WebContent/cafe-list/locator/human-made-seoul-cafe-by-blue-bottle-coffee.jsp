...
<head>
    ...
    <title>휴먼 메이드 서울 카페 바이 블루보틀 커피</title>
...
<body>
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                        <p class="pb-3 text-start">
                           	전 세계에 생기 넘치는 아이디어를 제공하는 근거지와 문화가 되는 것을 목표로 하는 HUMAN MADE와 함께하는 카페입니다. 
                           	HUMAN MADE의 ‘The Future Is In The Past’ 컨셉에서 영감을 받아 과거와 현대의 맛을 담은 익스클루시브 메뉴와 MD를 경험해 보세요.
                        </p>
                        <a href="https://naver.me/GL88ZWNO" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.5425331453144, 127.053233219739), // 휴먼 메이드
		    zoom: 17,
