...
<body>
        ...
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">서울 강남구 논현로 854</p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <strong class="mb-2">운영시간</strong>
                        <p class="mb-3">평일: 07:30 - 21:00 │ 주말: 08:00 - 21:00</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                       <p class="pb-3 text-start">
				                            반원형 펜던트 조명 및 의자, 서정화와 정용 디자이너와 협업한 바 스툴과 라운지 체어로 미적 요소를 더한 작품과 함께해 아름다움이 공존합니다. 
				                            차분하면서도 따뜻한 균형감이 돋보이는 압구정 카페에 방문해 보세요.
                        </p>
                        <a href="https://naver.me/GWe2TZcS" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/bluebottle-apgujung-cafe/img01.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-apgujung-cafe/img02.webp">               
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-apgujung-cafe/img03.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-apgujung-cafe/img04.webp">
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.5253215967063, 127.028865132152), // 압구정 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(37.5253215967063, 127.028865132152),
		    map: map,
		    title: "블루보틀 압구정 카페",
		    icon: {
		    	url: 'mapIcon.png',
