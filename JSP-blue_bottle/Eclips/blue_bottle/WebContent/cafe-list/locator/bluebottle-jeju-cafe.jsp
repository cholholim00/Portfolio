...
<body>
        ...
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">제주특별자치도 제주시 구좌읍 번영로 2133-30</p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <strong class="mb-2">운영시간</strong>
                        <p class="mb-3">매일 08:00 - 19:00 (대설 및 태풍 등의 자연재해 시, 단축 영업 또는 임시 휴무)</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                       <p class="pb-3 text-start">
				           ‘누구나 환영한다'는 의미를 가진 제주 정낭을 활짝 열면 드넓게 펼쳐지는 삼나무의 아름다운 광경을 만끽할 수 있는 카페입니다. 
				                            제주 해녀가 채취한 우뭇가사리를 오래 끓여 만든 수제 ‘커피푸딩'도 준비되어 있습니다.
                        </p>
                        <a href="https://naver.me/5gF9Cqrf" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/bluebottle-jeju-cafe/img01.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-jeju-cafe/img02.webp">               
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-jeju-cafe/img03.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-jeju-cafe/img04.webp">
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(33.4332787775206, 126.75085436919), // 제주 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(33.4332787775206, 126.75085436919),
		    map: map,
		    title: "블루보틀 제주 카페",
		    icon: {
		    	url: 'mapIcon.png',
