...
<body>
        ...
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">서울시 송파구 올림픽대로 300 롯데월드몰 1층</p>
                    </div>
                    <div class="col-12 col-lg-6">
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                        <p class="pb-3 text-start">
                            ‘롯데월드타워'에 위치한 잠실 카페는 서예 붓을 모티브로 건축된 건물 디자인과 조화를 이루기 위해 곳곳에 곡선 디자인을 반영하였습니다. 
                                                                      사계절의 온도를 느낄 수 있는 공간으로 여유로움을 즐겨 보세요.
                        </p>
                        <a href="https://naver.me/xguctD0a" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/bluebottle-jamsil-cafe/img01.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-jamsil-cafe/img02.webp">               
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-jamsil-cafe/img03.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-jamsil-cafe/img04.webp">
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.5137129859207, 127.104301829165), // 잠실 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(37.5137129859207, 127.104301829165),
		    map: map,
		    title: "블루보틀 잠실 카페",
		    icon: {
		    	url: 'mapIcon.png',
