...
<body>
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">서울시 강남구 테헤란로 517 1층</p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <strong class="mb-2">운영시간</strong>
                        <p class="mb-3">월-목: 08:00 - 20:00 │ 금-일: 08:00 - 20:30</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                        <p class="pb-3 text-start">
                           바쁘게 움직이는 도심 속 ‘온더고(on the go)’ 형태의 카페로 자리한 삼성 카페는 따뜻한 환기로 채워진 공간입니다. 
                           일상 속 오아시스처럼 잠시 발걸음을 멈추고 맛있는 커피 한 잔과 함께 의도된 공백을 즐겨 보세요.
                        </p>
                        <a href="https://naver.me/FEU1wa1D" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.5086151302204, 127.059765116537), // 삼성 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(37.5086151302204, 127.059765116537),
		    map: map,
		    title: "블루보틀 삼성 카페",
		    icon: {
		    	url: 'mapIcon.png',
