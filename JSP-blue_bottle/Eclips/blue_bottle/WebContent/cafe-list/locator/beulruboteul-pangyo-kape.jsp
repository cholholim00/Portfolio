...
<!-- 네비게이션 바 -->
        ...
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">경기 성남시 분당구 동판교로177번길 25</p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <strong class="mb-2">운영시간</strong>
                        <p class="mb-3">매일 08:00 - 21:30</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                        <p class="pb-3 text-start">
                           디지털 도시 판교와 대비되어 산들바람이 일렁이는 벤치와 저녁 밥상을 연상하는 원목 테이블까지 목적 없는 사색을 즐기기 좋은 공간입니다. 
                           일상에 환기가 필요할 때 맛있는 커피 한 잔으로 아늑함을 즐겨 보세요.
                        </p>
                        <a href="https://naver.me/F9z8ITqR" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/beulruboteul-pangyo-kape/img01.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/beulruboteul-pangyo-kape/img02.webp">               
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/beulruboteul-pangyo-kape/img03.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/beulruboteul-pangyo-kape/img04.webp">
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.3973207561987, 127.11356226927), // 판교 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(37.3973207561987, 127.11356226927),
		    map: map,
		    title: "블루보틀 판교 카페",
		    icon: {
		    	url: 'mapIcon.png',
