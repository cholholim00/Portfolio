...
<head>
    ...
    <script type="text/javascript" src="https://oapi.map.naver.com/openapi/v3/maps.js?ncpKeyId=sj9hxvt3k0"></script>
</head>
<body>
    <!-- 네비게이션 바 -->
        ...
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="row map-container mt-4 g-0 pb-5 px-lg-4 px-1">
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                    	<span>블루보틀 수원 타임빌라스 팝업</span>
                        <p class="pb-3 text-start">
                            수원 스타필드에서의 작은 여유에 이어, 더 깊어진 커뮤니티와의 연결 속에서 오픈한 ‘수원 타임빌라스 팝업'에서 새로운 인사를 드립니다. 
                            맛있는 한 잔의 커피로 게스트 분들의 바쁜 일상 속에 소소한 여유를 선사하고자 합니다. 커피가 필요한 순간, 블루보틀을 찾아보세요
                        </p>
                        <a href="https://naver.me/F5D1o9r3" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/blue-bottle-coffee-suwon-timevillas-pop-up/img01.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/blue-bottle-coffee-suwon-timevillas-pop-up/img02.webp">               
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/blue-bottle-coffee-suwon-timevillas-pop-up/img03.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/blue-bottle-coffee-suwon-timevillas-pop-up/img04.webp">
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.264162726921, 126.997385539043), // 수원 타임빌라스 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(37.264162726921, 126.997385539043),
		    map: map,
		    title: "블루보틀 수원 타임빌라스 팝업",
		    icon: {
		    	url: 'mapIcon.png',
