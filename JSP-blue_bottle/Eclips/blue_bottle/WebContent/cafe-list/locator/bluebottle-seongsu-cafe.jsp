...
<body>
        ...
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">서울특별시 성동구 아차산로 7</p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <strong class="mb-2">운영시간</strong>
                        <p class="mb-3">매일 07:30 - 20:30</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                       <p class="pb-3 text-start">
				                            성수 카페는 산업의 중심지에 있던 성수 커뮤니티의 특색을 담아 붉은 벽돌 건물에 콘크리트와 
				                            스테인리스 스틸 소재를 활용해 탄생되었습니다. 
				                            차분하면서도 안락감을 안기는 성수 카페에서 맛있는 커피 한 잔을 즐겨 보세요.
                        </p>
                        <a href="https://naver.me/5XJIYguc" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/bluebottle-seongsu-cafe/img01.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-seongsu-cafe/img02.webp">               
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-seongsu-cafe/img03.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-seongsu-cafe/img04.webp">
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.5481060299191, 127.045641393072), // 성수 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(37.5481060299191, 127.045641393072),
		    map: map,
		    title: "블루보틀 성수 카페",
		    icon: {
		    	url: 'mapIcon.png',
