...
<body>
        ...
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">서울 영등포구 여의대로 108 더현대서울점 5층</p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <strong class="mb-2">운영시간</strong>
                        <p class="mb-3">평일: 10:30 - 21:00 │ 주말: 10:30 - 21:30 (백화점 휴점일 제외)</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                       <p class="pb-3 text-start">
				           ‘더현대 서울' 5층에 위치한 여의도 카페는 유리 천장의 햇살이 실내 정원과 이어져 자연의 온기를 느낄 수 있습니다. 
				                            부드러운 곡선의 벽체와 벽면을 따라 이어지는 은은한 라이팅으로 아늑함 속 잠시의 휴식에 취해 보세요.
                        </p>
                        <a href="https://naver.me/FQVGMUMz" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/bluebottle-yeouido-cafe/img01.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-yeouido-cafe/img02.webp">               
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.5251913154781, 126.929112756574), // 여의도 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(37.5251913154781, 126.929112756574),
		    map: map,
		    title: "블루보틀 여의도 카페",
		    icon: {
		    	url: 'mapIcon.png',
