...
<body>
        ...
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">부산광역시 수영구 민락수변로 243 1, 4, 5층 (민락동)</p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <strong class="mb-2">운영시간</strong>
                        <p class="mb-3">[4F] 매일 08:30 - 22:00 │ [1F] 매일 08:30 - 21:00</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                        <p class="pb-3 text-start">
                            산과 바다, 강이 만나는 교차점에서 다채로운 풍경을 마주한 ‘블루보틀 부산 민락 카페’는 이 도시의 특유의 활기와 문화적 융합, 무한한 가능성을 담았습니다. 
                            부산 도심을 파노라마 뷰로 담을 수 있는 창가 자리부터 오직 부산 민락 카페에서만 만나볼 수 있는 디저트 메뉴까지 색다른 감미로움을 커피와 함께 즐겨 보세요.
                        </p>
                        <a href="https://naver.me/F0z2RkaA" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/blue-bottle-busan-millak-cafe/img01.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/blue-bottle-busan-millak-cafe/img02.webp">               
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/blue-bottle-busan-millak-cafe/img03.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/blue-bottle-busan-millak-cafe/img04.webp">
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(35.1641035234731, 129.128255094692), // 부산 민락 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(35.1641035234731, 129.128255094692),
		    map: map,
		    title: "블루보틀 부산 민락 카페",
		    icon: {
		    	url: 'mapIcon.png',
