...
<body>
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">서울 강남구 테헤란로 129 강남N타워</p>
                    </div>
                    <div class="col-12 col-lg-6">
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                       <p class="pb-3 text-start">
				                            창 너머 보이는 대나무와 카페 내부의 나무 기둥은 작은 대나무 숲에 머무는 듯한 느낌을 선사합니다. 
				                            도심 속 오아시스와 같은 역삼 카페에서 통유리창으로 스며드는 자연광을 즐겨 보세요.
                        </p>
                        <a href="https://naver.me/F74VogQT" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.4999326440603, 127.032367803374), // 역삼 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(37.4999326440603, 127.032367803374),
		    map: map,
		    title: "블루보틀 역삼 카페",
		    icon: {
		    	url: 'mapIcon.png',
