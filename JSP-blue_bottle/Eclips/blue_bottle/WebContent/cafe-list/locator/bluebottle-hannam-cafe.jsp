...
<body>
        ...
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">서울 용산구 한남대로 91</p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <strong class="mb-2">운영시간</strong>
                        <p class="mb-3">평일: 09:00 - 20:30 │ 주말: 08:00 - 20:30</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                       <p class="pb-3 text-start">
				                            통유리창 너머 아담한 정원이 펼쳐지는 한남 카페에서 에너지를 충전해 보세요. 
				                            조선 후기 사방탁자에서 영감을 받은 목재 디테일과 강의 투명함을 연상시키는 아크릴 및 유리 소재에서 안정적인 쉼을 느낄 수 있습니다.
                        </p>
                        <a href="https://naver.me/Fuz5m1sJ" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/bluebottle-hannam-cafe/img01.webp">
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.5425331453144, 127.053233219739), // 휴먼메이드 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(37.5425331453144, 127.053233219739),
		    map: map,
		    title: "휴먼 메이드 서울 카페 바이 블루보틀 커피",
		    icon: {
		    	url: 'mapIcon.png',
