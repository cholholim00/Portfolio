...
<body>
        ...
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">서울 마포구 성미산로32길 52 B1F - 1F</p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <strong class="mb-2">운영시간</strong>
                        <p class="mb-3">매일: 09:00 - 21:00</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                        <p class="pb-3 text-start">
                           연남 카페는 연남동 옛 골목길의 정취에서 영감을 받아 현대적으로 재해석하였습니다. 
                           주민들이 담소를 나누던 평상, 집의 담벼락을 둘러싼 파이프라인을 모던하게 해석한 아이코닉한 공간에서 노스탤지어를 느껴 보세요.
                        </p>
                        <a href="https://naver.me/G4xNH4Bi" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/bluebottle-yeonnam-cafe/img01.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-yeonnam-cafe/img02.webp">               
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/bluebottle-yeonnam-cafe/img03.webp">
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(37.5629616832042, 126.922426025284), // 연남 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(37.5629616832042, 126.922426025284),
		    map: map,
		    title: "블루보틀 연남 카페",
		    icon: {
		    	url: 'mapIcon.png',
