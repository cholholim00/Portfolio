...
<body>
        ...
        <div class="row align-items-start text-lg-start text-center">
            ...
            <div class="col-12 col-lg-6 body-article pt-5 px-4">
                <div class="row flex-column flex-md-row">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="mb-2">부산 기장군 장안읍 정관로 1133 부산 프리미엄 아울렛 578호</p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <strong class="mb-2">운영시간</strong>
                        <p class="mb-3">매일 10:30 - 21:00</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="map-article py-2">
                       <p class="pb-3 text-start">
				                            일상의 공간이자 여행지에 위치한 기장 카페에서 하루의 활기를 채워 보세요.
				                            투명한 파사드와 폴딩 도어는 맛있는 커피 한 잔과 어울리는 아름다운 풍경을 담아내고,
				                            벽면을 채운 그라데이션 알루미늄 패널은 시간에 따라 변하는 빛과 공기의 흐름을 반영합니다.
				                            풍미 가득한 향은 밖으로, 따스한 햇살의 온기는 안으로 머무르며 실내외 경계에 자리한
				                            기장 카페에 게스트 분들을 초대합니다.
                        </p>
                        <a href="https://naver.me/F42yk6PB" class="N-link">지도 보기</a>
                    </div>
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
            ...
            <div class="row cafe-img mb-4 px-lg-5 px-1 g-0">
                <div class="img-box col-12 my-lg-5 mt-5">
                    <img src="images/busan-gijang-cafe/img01.webp">
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/busan-gijang-cafe/img02.webp">               
                </div>
                <div class="img-box col-12 my-5">
                    <img src="images/busan-gijang-cafe/img03.webp">
                </div>
            </div>
            <div class="py-3 py-lg-5"></div>  <!-- 패딩 -->
    ...
    <script>
		var map = new naver.maps.Map('map', {
		    center: new naver.maps.LatLng(35.3249413082094, 129.236072800234), // 부산 기장 좌표
		    zoom: 17,
		    mapTypeControl: false,
		    mapTypeId: naver.maps.MapTypeId.NORMAL
		});
		var marker = new naver.maps.Marker({
		    position: new naver.maps.LatLng(35.3249413082094, 129.236072800234),
		    map: map,
		    title: "블루보틀 부산 기장 카페",
		    icon: {
		    	url: 'mapIcon.png',
