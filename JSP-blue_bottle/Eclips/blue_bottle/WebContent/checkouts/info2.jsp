...
<%
		...
		String name = ln+fn;
		String post_num = request.getParameter("postnum");
		String addr = request.getParameter("addr");
		String detail_addr = request.getParameter("detailAddr");
	  ...
	  // 확인을 위한 출력
	  for (int i = 1; i < index; i++) {
	      System.out.println("name: " + names[i] + ", quantity: " + quantities[i] + ", price: " + prices[i] + ", produdt_idx: " + products[i]);
	  }
    ...
    <div class="row">
        <div class="col my_right">
		            ...
		            <div class="mt-3" style="font-size: 12px;">
		                <span>카트</span> > <span>정보</span> > <span class="fw-bold">배송</span> > <span>지급</span>
		            </div>
		            ...
		            <div class="mt-5">
		                ...
		                <div class="mt-5">
		                    <p class="fw-bold" style="font-size: 18px;">배송 방법</p>
		                    <div class="card" style="width: 100%; padding: 20px; font-size: 14px; border-color: rgb(2, 164, 225); background-color: rgb(239, 247, 255);">
		                    <div class="row">
		                        <div class="col-10 me-5">CJ대한통운</div>
		                        <div class="col fw-bold">₩0</div>
		                    </div>
		                </div>
		            </div>
		            
								<form action="info3.jsp?idx=<%=user_idx %>" method="post">
                    <!-- 버튼 -->
                    <div class="d-flex mt-4 mb-4">
                        <span class="mt-4"><a href="#" style="text-decoration: none;">< 정보로 돌아가기</a></span>
                        ...
                        <% for(int i=1; i<index; i++){ %>
		                    ...
		                    <input type="hidden" name="addr" value="<%=addr+" "+detail_addr+" "+extraAddr%>">
		                    <input type="hidden" name="phone" value="<%=phone%>">
		                    
                        <input type="submit" class="btn btn-primary ms-auto" style="height: 60px; width: 150px;" value="지불 계속하기">
                    </div>
                </form>
                <!-- footer -->
