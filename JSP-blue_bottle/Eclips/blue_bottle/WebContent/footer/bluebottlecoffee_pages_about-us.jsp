...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="bluebottlecoffee_pages_about-us.css">
  ...
  <body>
    ...
    <div class="b-body-all">
	    <div class="main-banner">
		    <img src="./images/BBC-PLP-NewCafeOpening-Desktop.webp" class="img-fluid" alt="메인 이미지">
		    <div class="banner-text">Our Story</div>
		</div>
		<br><br>
		...
		<div class="text-box-out mt-5">
			<div class="text-box">
				<div class="textbox-header">
					<h3>콜시츠키와 최초의 블루보틀 </h3>
				</div>
				
				<div class="textbox-body">
					<p>전해져 내려오는 이야기는 이렇게 시작됩니다.<br>
					<br>
					1600년대 말, 중부 및 동부 유럽의 대부분을 점령하고 있던 터키군은 1683년 비엔나에 도착했습니다. 군에 포위되어 절망적인 상황에 놓인 비엔나 사람들은 터키 군의 포위망을 뚫고 인근에 주둔해 있는 폴란드 군대에게 자신들의 메시지를 전해줄 특사가 필요했습니다. 이때, 터키어와 아랍어에 능통한 프란츠 조지 콜시츠키(Franz George Kolshitsky)가 터키군으로 위장하여 이 일을 수행하기로 합니다. 위험천만한 위기의 순간을 여러 번 넘긴 후 마침내 콜시츠키는 모든 임무를 용맹하게 완수해내고, 곧 다가올 폴란드의 지원 소식을 비엔나에 다시 전하게 됩니다.<br>
					<br>
					그 해 9월 13일, 터키군은 결국 가지고 왔던 모든 것을 남겨둔 채 격퇴되었고, 그중에는 낙타 먹이로 보이는 이상한 콩이 잔뜩 들어있는 천 꾸러미도 있었습니다. 아랍 국가에서 여러 해 살았던 콜시츠키는 이 콩들이 바로 커피라는 것을 알고 있었습니다. 그는 비엔나 시장에게서 받은 상금으로 커피를 사고, 중부 유럽 최초의 커피 하우스(The Blue Bottle)를 열어 비엔나에 커피를 소개했습니다.</p>
				</div>
			</div>
		</div>
		...
		<div class="img-box-out">
			<div class="img-box">
				<img src="./images/ourstory.webp" class="" width="1232px" height="616px">
			</div>
		</div>
		...
		<div class="text-box-out mt-5">
			<div class="text-box">
				<div class="textbox-header">
					<h3>그로부터 300여년이 지난 후 </h3>
				</div>
				
				<div class="textbox-body">
					<p>2000년대 초반 캘리포니아 주 오클랜드에는 다소 불만이 많은 프리랜서 음악가이자 커피광인 제임스 프리먼이라는 청년이 있었습니다. 상업적인 커피 회사와 신선하지 않고 과하게 로스팅 된 커피에 질린 그는 신선한 커피 본연의 맛을 갈구하는 사람들을 위해 스스로 커피를 로스팅 하기로 결심했습니다.<br>
					<br>
					그는 콜시츠키의 용감한 행동에 경의를 표하며, 자신의 가게를 블루보틀 커피(Blue Bottle Coffee)로 짓고, 최상급 커피 역사의 새로운 장을 열었습니다.<br>
					<br>
					그로부터 지금까지, 블루보틀 커피는 수많은 고객의 열렬한 성원에 힘입어 미국 전역과 일본, 그리고 한국을 잇는 세계적인 카페 네트워크로 성장했습니다. 예전이나 지금이나, 우리는 훌륭한 커피를 원하는 모든 사람에게 제공하자는 단순한 목적으로 연결되어 있습니다. 대신 커피의 신선함과 맛의 정점에 대해서는 이전보다 더 섬세해졌습니다. 그리고 믿기지 않지만 정말 기쁘게도, 이제 우리는 백개가 넘는 카페를 열게 되었습니다.</p>
				</div>
			</div>
		</div>
		
		<div class="img-box-out2">
			<div class="img-box2">
				<img src="./images/ourstory_02.webp" class="" width="1232px" height="616px">
			</div>
		</div>
		...
		<div class="text-box-out mt-5">
			<div class="text-box">
				<div class="textbox-header">
					<h3>저희가 직접 커피를 가져다드릴게요 </h3>
				</div>
				
				<div class="textbox-body" font-size="18px">
					<p>처음 시도했던 커피 판매 방식은 즐거웠지만 오래가지 못했습니다.<br>
					<br>
					우리는 고객들에게 전화를 걸어 좋아하는 커피 취향과 보통 얼마나 자주 마시는지에 대해 대화했고, 대화가 잘 진행되면 그들의 결제정보를 받은 후 일주일에 한 번 그들의 집으로 커피를 직접 배달하는 서비스였습니다.<br>
					<br>
					이는 사실 여러 가지 면에서 다소 번거로운 비즈니스 모델이었고, 특히 당시 제임스의 자가용이었던 푸조 505 웨건에 실을 수 있는 커피의 양도 매우 한정적이었습니다. 하지만 우리가 계속해서 하고자 하는 바는 지금도 여전히 이것과 크게 다르지 않습니다.<br>
					<br>
					우리는 전 세계의 여러 농부들과 직접 함께 일하며 우리가 찾을 수 있는 가장 맛있고 지속 가능한 커피를 구하고 있습니다. 그리고 그 커피를 우리만의 정밀한 플레이버 기준에 맞춰 이를 로스팅하고, 커피가 가장 맛있는 정점의 기간에 여러분에게 즐거운 대화나 친밀한 조언과 함께 제공합니다. 우리가 존경하는 농부들의 손에서 길러진 가장 좋아하는 커피를 당신에게 직접 전하고 당신의 집으로 전달하는 것은 우리에게 영광의 순간이라 생각합니다.</p>
				</div>
			</div>
		</div>
		...
		<div class="img-box-out2">
			<div class="img-box2">
				<img src="./images/ourstory_03.webp" class="" width="1232px" height="616px">
			</div>
		</div>
		
		<div class="text-box-out2 mt-5">
			<div class="text-box2">
				<div class="textbox-header">
					<h3>블루보틀의 사람들은 누구일까요? </h3>
				</div>
				
				<div class="textbox-body2" font-size="18px">
					<p>블루보틀의 직원들은 가장 친절하고 열심히 일하면서도, 각자의 능력이 뛰어납니다. 놀라울 만큼 다양성이 넘치는 우리 조직에는 커피 전문가부터 아티스트, 작가, 미각 전문가, 제빵사, 디자이너, 그리고 다방면의 꿈을 가진 사람들이 있습니다. 블루보틀에서는 언제나 다재다능한 팀원들을 기다리고 있습니다.</p>
				</div>
			</div>
		</div>
		
		<div class="img-box-out3">
			<div class="img-box3">
				<img src="./images/3433536567_1.webp" class="" width="1480px" height="832px">
			</div>
		</div>
	</div>
